...
import {PipelineCreate, PipelineEdit, PipelineList, PipelineShow} from "./pages/pipelines";
import {RecipientCreate, RecipientEdit, RecipientList, RecipientShow} from "./pages/recipients";
			...
			<RefineKbarProvider>
				<ColorModeContextProvider>
					...
					<RefineSnackbarProvider>
						<DevtoolsProvider>
							<Refine
								dataProvider={dataProvider("http://127.0.0.1:8000/api/v1")}
