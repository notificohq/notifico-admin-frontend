...
import {Box, TextField, Autocomplete, Typography, Button, Stack} from "@mui/material";
						...
						<Autocomplete
							...
							renderInput={(params) => (
								<TextField
									...
									helperText={
										(errors as any)?.group_ids?.message
									}
									required
								/>
							)}
